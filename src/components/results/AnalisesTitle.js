  ...
  return (
    <React.Fragment>
      <tr className = {styles.titleRow}>
        ...
        <th rowSpan = '2' className = {styles.item}>Copy</th>
      <th rowSpan = '2' className = {styles.item}>Paste</th>
      <th rowSpan = '2' className = {styles.item}>Hidden</th>
      <th rowSpan = '2' className = {styles.item}>Screen</th>
      <th rowSpan = '2' className = {styles.item}>Real mark</th>
      </tr>
